...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var _itsaReactButton = __webpack_require__(169);

	var _itsaReactButton2 = _interopRequireDefault(_itsaReactButton);

	var _itsaUtils = __webpack_require__(174);

	__webpack_require__(180);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var MAIN_CLASS = "itsa-select",
	...
	var Component = _react2.default.createClass({
	    ...
	    propTypes: {
	        ...
	        */
	         ...
	         * @since 0.0.1
	        */
	        emptyHTML: _react.PropTypes.string,
	        ...
	        */
	         ...
	         * @since 0.0.1
	        */
	        listHeight: _react.PropTypes.string,
	    ...
	    componentDidMount: function componentDidMount() {
	        var instance = this;
	        instance._componentNode = _reactDom2.default.findDOMNode(instance);
	     ...
	     * @since 0.0.1
	     */
	    handleClick: function handleClick(simulated) {
	        var liNode = void 0,
	            ulNode = void 0;
	        var instance = this,
	        ...
	        if (leftBtnClick) {
	            ...
	            (0, _itsaUtils.async)(function () {
	                ...
	                if (!instance._mouseDown && !simulatedClick) {
	                    instance._removeTimer = (0, _itsaUtils.later)(function () {
	     ...
	     * @since 0.0.1
	     */
	    handleItemScroll: function handleItemScroll(e) {
	        var len = void 0,
	            liNode = void 0,
	            ulNode = void 0,
	            refocus = void 0;
	    ...
	    render: function render() {
	        ...
	        listItems = items.map(function (item, i) {
	            ...
	            var renderedItem = itemRenderer(item, i);
	            if (i === selected) {
	                classname = "selected";
	            ...
	            return _react2.default.createElement("li", { "aria-label": ariaLabel, "data-id": i, className: classname, dangerouslySetInnerHTML: dangerouslySetInnerHTML, key: i, role: "listitem", tabIndex: tabIndex });
	        });
	        ...
	        if (required && props.markRequired && !hasSelection) {
	            requiredMsg = _react2.default.createElement("div", { className: MAIN_CLASS_PREFIX + "required" });
	            ariaRequired = true;
	        }
	        if (!disabled) {
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(_itsaReactButton2.default, _extends({}, props, {
	            ...
	            _react2.default.createElement(
	                "div",
	                { className: containerClass, onKeyDown: itemScroll },
	                _react2.default.createElement(
	                    "div",
	                    { className: containerSubClass, style: containerStyles },
	                    _react2.default.createElement(
	                        "ul",
	                        {
	     ...
	     * @since 0.0.1
	     */
	    _defaultItemRenderer: function _defaultItemRenderer(item) {
	        return item;
	    },
	     ...
	     * @since 0.0.1
	     */
	    _getUlContainerNode: function _getUlContainerNode() {
	        var instance = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var _itsaUtils = __webpack_require__(170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	   idGenerator: __webpack_require__(171).idGenerator,
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(173).setImmediate, __webpack_require__(8)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	   ...
	   later: __webpack_require__(179).later,
	   async: __webpack_require__(179).async
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (win) {
	    ...
	    __webpack_require__(183)(win);
	    __webpack_require__(184)(win);
	}
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
	        ...
	        if (currentLeft !== newLeft || currentTop !== newTop) {
	            if (transitionTime) {
	                if (windowContainer && calcSupport === undefined) {
	                    calcSupport = __webpack_require__(191)(WINDOW);
	                }
	                ...
	                if (windowContainer && css3Transition && calcSupport) {
	                    ...
	                    vendorTransition || (vendorTransition = __webpack_require__(192)(WINDOW).generator(TRANSITION));
	                    ...
	                    evTransitionEnd || (evTransitionEnd = __webpack_require__(193)("./vendor-" + TRANSITION + "-end")(WINDOW));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	   idGenerator: __webpack_require__(189).idGenerator,
	   later: __webpack_require__(190).later,
	   async: __webpack_require__(190).async
	};
